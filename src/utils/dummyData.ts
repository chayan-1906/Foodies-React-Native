...
export const filtersOption = ['Nearest', 'Great Offers', 'Rating 4.0', 'Gourmet', 'Pure Veg'];

export const restaurantsItemFiltersOption = ['Veg', 'Non-veg', 'Rating 4.0', 'Bestseller', 'Spicy', 'Sweets'];
